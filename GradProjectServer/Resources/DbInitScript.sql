...
CREATE TABLE "ExamsAttempts" (
                                 ...
                                 CONSTRAINT "FK_ExamsAttempts_Users_OwnerId" FOREIGN KEY ("OwnerId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "BlankSubQuestion" (
                                    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                    "HasChecker" boolean NOT NULL,
                                    "IsCheckerBuilt" boolean NOT NULL,
...
CREATE TABLE "ProgrammingSubQuestion" (
                                          "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                          "KeyAnswerFileExtension" text NOT NULL,
                                          "IsCheckerBuilt" boolean NOT NULL DEFAULT FALSE,
...
CREATE TABLE "SubQuestionAnswer" (
                                     ...
                                     "ExamSubQuestionId" integer NOT NULL,
                                     ...
                                     CONSTRAINT "FK_SubQuestionAnswer_ExamSubQuestions_ExamSubQuestionId" FOREIGN KEY ("ExamSubQuestionId") REFERENCES "ExamSubQuestions" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "MCQSubQuestionsChoices" (
                                          ...
                                          "Content" text NOT NULL,
                                          "Weight" real NOT NULL,
                                          CONSTRAINT "PK_MCQSubQuestionsChoices" PRIMARY KEY ("Id"),
...
CREATE TABLE "BlankSubQuestionAnswer" (
                                          "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                          "Answer" text NOT NULL,
                                          CONSTRAINT "PK_BlankSubQuestionAnswer" PRIMARY KEY ("Id"),
                                          CONSTRAINT "FK_BlankSubQuestionAnswer_SubQuestionAnswer_Id" FOREIGN KEY ("Id") REFERENCES "SubQuestionAnswer" ("Id") ON DELETE CASCADE
);

CREATE TABLE "ProgrammingSubQuestionAnswer" (
                                                "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                "FileExtension" text NOT NULL,
                                                "ProgrammingLanguage" smallint NOT NULL,
                                                CONSTRAINT "PK_ProgrammingSubQuestionAnswer" PRIMARY KEY ("Id"),
                                                CONSTRAINT "FK_ProgrammingSubQuestionAnswer_SubQuestionAnswer_Id" FOREIGN KEY ("Id") REFERENCES "SubQuestionAnswer" ("Id") ON DELETE CASCADE
);

CREATE TABLE "MCQSubQuestionAnswer" (
                                        "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                        "ChoiceId" integer NOT NULL,
                                        CONSTRAINT "PK_MCQSubQuestionAnswer" PRIMARY KEY ("Id"),
                                        CONSTRAINT "FK_MCQSubQuestionAnswer_MCQSubQuestionsChoices_ChoiceId" FOREIGN KEY ("ChoiceId") REFERENCES "MCQSubQuestionsChoices" ("Id") ON DELETE CASCADE,
                                        CONSTRAINT "FK_MCQSubQuestionAnswer_SubQuestionAnswer_Id" FOREIGN KEY ("Id") REFERENCES "SubQuestionAnswer" ("Id") ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX "IX_ExamsAttempts_OwnerId" ON "ExamsAttempts" ("OwnerId");
...
CREATE INDEX "IX_MCQSubQuestionAnswer_ChoiceId" ON "MCQSubQuestionAnswer" ("ChoiceId");
...
CREATE INDEX "IX_SubQuestionAnswer_ExamSubQuestionId" ON "SubQuestionAnswer" ("ExamSubQuestionId");
