...
CREATE TABLE "ExamsSubQuestions" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "SubQuestionId" integer NOT NULL,
    "Weight" real NOT NULL,
    "ExamQuestionId" integer NOT NULL,
    "Order" integer NOT NULL,
    CONSTRAINT "PK_ExamsSubQuestions" PRIMARY KEY ("Id"),
    CONSTRAINT "CK_EXAMSUBQUESTION_WEIGHT" CHECK ("Weight" > 0),
    CONSTRAINT "CK_EXAMSUBQUESTION_ORDER" CHECK ("Order" >= 0),
    CONSTRAINT "FK_ExamsSubQuestions_ExamsQuestions_ExamQuestionId" FOREIGN KEY ("ExamQuestionId") REFERENCES "ExamsQuestions" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_ExamsSubQuestions_SubQuestions_SubQuestionId" FOREIGN KEY ("SubQuestionId") REFERENCES "SubQuestions" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "SubQuestionsAnswers" (
    ...
    CONSTRAINT "FK_SubQuestionsAnswers_ExamsSubQuestions_SubQuestionId" FOREIGN KEY ("SubQuestionId") REFERENCES "ExamsSubQuestions" ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_ExamsSubQuestions_ExamQuestionId" ON "ExamsSubQuestions" ("ExamQuestionId");

CREATE INDEX "IX_ExamsSubQuestions_SubQuestionId" ON "ExamsSubQuestions" ("SubQuestionId");
